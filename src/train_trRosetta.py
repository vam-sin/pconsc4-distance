...
keys_train, keys_test = train_test_split(total_keys, test_size=0.05, random_state=42)
print(len(keys_train), len(keys_test))

# keys_train = total_keys
...
if num_classes == 7:
  ...
  weights = [2.00393768, 8.01948742, 8.77744028, 5.19939732, 3.37958688, 2.08356088, 0.20463084]
  # hyperopt weights
  # weights = [0.1929317781884383, 0.18794372886630434, 0.7968968753896802, 0.06816248913430835, 0.3145274731526676, 0.0001403478005401193, 0.9281697476380049]
...
mcp_save = keras.callbacks.callbacks.ModelCheckpoint('models/rosetta_90.h5', save_best_only=True, monitor='val_loss', verbose=1)
