...
if num_classes == 7:
  weights = [2.00393768, 8.01948742, 6.77744028, 5.19939732, 3.37958688, 3.08356088, 0.0018463084]
...
mcp_save = keras.callbacks.callbacks.ModelCheckpoint('models/vgg.h5', save_best_only=True, monitor='val_loss', verbose=1)
...
adam = keras.optimizers.Adam(learning_rate = 1e-9)
...
Previous Model: model_unet_7_672.h5: 0.5591865122940344 
