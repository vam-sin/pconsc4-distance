...
if __name__ == '__main__':
    ...
    for i in range(y.shape[0]-64):
        for j in range(y.shape[1]-64):
            x_64 = {}
            y_prime = y[np.ix_(range(i, i+64), range(j, j+64))]
            ...
            print(i, j, y_prime.shape, x_64["gdca"].shape, x_64["cross_h"].shape, x_64["mi_corr"].shape, x_64["nmi_corr"].shape, x_64["seq_input"].shape)
